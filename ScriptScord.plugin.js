...
module.exports = ((_) => {
    const config = {
        info: {
            ...
            version: "1.0.0",
            description:
                "allow user to run script from js embeded discord messages",
        },
    };
                                  ...
                                  require("request").get(
                                      ...
                                      (e, r, b) => {
                                          if (
                                              ...
                                              BdApi.alert(
                                                  "Error",
                                                  "Could not download BDFDB Library Plugin, try again later or download it manually from GitHub: https://github.com/mwittrien/BetterDiscordAddons/tree/master/Library/"
                                              );
                                      }
                                  );
                              },
        ...
        : (([Plugin, BDFDB]) => {
              return class ScriptScord extends Plugin {
                  ...
                  processMessageContent(e) {
                      ...
                      if (
                          e.instance.props.message.content &&
                          /^.*```(js|javascript)\n(.+)```.*$/gis.test(
                              e.instance.props.message.content
                          )
                      ) {
                          ...
                          let msgElement = document.getElementById(
                              "chat-messages-" + e.instance.props.message.id
                          );
                          if (!msgElement) return;

                          let old = document.getElementById(
                              "execjs-" + e.instance.props.message.id
                          );
                          let btn = document.createElement("button");

                          function getMessage() {
                              return document.getElementById(
                                  "chat-messages-803857194575069214"
                              );
                          }
                    ...
                    async function loadScript(urlhttp) {
                        return new Promise((resolve, reject)=>{
                            fetch(urlhttp).then(async (response) => {
                          ...
                          btn.addEventListener("click", function () {
                              ...
                              console.log(
                                  `%crunning embeded script with ScriptScord by BurnGemios3643\nGithub: https://github.com/leopoldhub`,
                                  `background: #03adfc; color: #ffffff`
                              );
                          ...
                          if (old != undefined && old != null)
                              msgElement.replaceChild(btn, old);
                          ...
                          let oldON = document.getElementById(
                              "execcss-" + e.instance.props.message.id
                          );
                          ...
                          btnON.addEventListener("click", function () {
                              ...
                              console.log(
                                  `%crunning embeded CSS with ScriptScord by BurnGemios3643\nGithub: https://github.com/leopoldhub`,
                                  `background: #34bf2a; color: #ffffff`
                              );
                              console.log(`css code: \n${css}`);
                              let oldstyle = document.getElementById(
                                  "css-preview-" + e.instance.props.message.id
                              );
                              ...
                              if (oldstyle != undefined && oldstyle != null)
                                  oldstyle.parentNode.replaceChild(
                                      style,
                                      oldstyle
                                  );
                              else
                          ...
                          if (oldON != undefined && oldON != null)
                              msgElement.replaceChild(btnON, oldON);
                          else msgElement.appendChild(btnON);

                          let oldOFF = document.getElementById(
                              "remcss-" + e.instance.props.message.id
                          );
                          ...
                          btnOFF.addEventListener("click", function () {
                              ...
                              console.log(
                                  `%cremoving embeded CSS with ScriptScord by BurnGemios3643\nGithub: https://github.com/leopoldhub`,
                                  `background: #34bf2a; color: #ffffff`
                              );
                              console.log(`css code: \n${css}`);
                              let oldstyle = document.getElementById(
                          ...
                          if (oldOFF != undefined && oldOFF != null)
                              msgElement.replaceChild(btnOFF, oldOFF);
